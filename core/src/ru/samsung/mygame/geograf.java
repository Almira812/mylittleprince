...
public class geograf implements Screen {
    ...
    public geograf(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/4.Geograf/1.38smotrite.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.geograf1);             //       !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
