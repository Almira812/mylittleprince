...
public class fx3 implements Screen {
    ...
    public fx3(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/4you.37.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx4);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
