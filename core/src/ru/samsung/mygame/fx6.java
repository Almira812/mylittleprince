...
public class fx6 implements Screen {
    ...
    public fx6(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/7yes.14.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx7);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
