...
public class fonar3 implements Screen {
    ...
    public fonar3(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/3.Fonar/4.27goodnight.png")); // находит картинку с анимацией
