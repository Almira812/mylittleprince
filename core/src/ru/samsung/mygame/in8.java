...
public class in8 implements Screen {
    ...
    private static final int FRAME_COLS = 8, FRAME_ROWS = 4;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public in8(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("day2/frost.8.31.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.int9);
            }
