...
public class fx5 implements Screen {
    ...
    public fx5(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/6butyou.21.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx6);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
