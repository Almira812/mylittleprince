...
public class snake3 implements Screen {
    ...
    public snake3(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/4onearth.19.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake4);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
