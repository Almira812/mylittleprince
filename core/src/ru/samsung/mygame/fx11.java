...
public class fx11 implements Screen {
    ...
    public fx11(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/12iopen.34.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.FifthDayNight);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
