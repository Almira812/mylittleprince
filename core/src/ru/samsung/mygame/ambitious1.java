...
public class ambitious1 implements Screen {
    ...
    private static final int FRAME_COLS = 2, FRAME_ROWS = 19;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public ambitious1(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/2.Ambitious/2.37goodday.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.ambitious2);     //               !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
