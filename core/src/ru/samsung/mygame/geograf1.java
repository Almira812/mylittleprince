...
public class geograf1 implements Screen {
    ...
    public geograf1(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/4.Geograf/2.21what.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.geograf2);             //       !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
