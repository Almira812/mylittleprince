...
public class snake11 implements Screen {
    ...
    public snake11(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/12everyone37.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake12);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
