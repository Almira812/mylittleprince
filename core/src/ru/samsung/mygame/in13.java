...
public class in13 implements Screen {
    ...
    private static final int FRAME_COLS = 45, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("rose.13.45.png")); // находит картинку с анимацией
