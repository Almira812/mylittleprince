...
public class fx8 implements Screen {
    ...
    public fx8(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/9no.16.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx9);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
