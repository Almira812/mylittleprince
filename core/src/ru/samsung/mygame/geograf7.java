...
public class geograf7 implements Screen {
    ...
    public geograf7(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/4.Geograf/8.44earth.png")); // находит картинку с анимацией
