...
public class snake7 implements Screen {
    ...
    private static final int FRAME_COLS = 4, FRAME_ROWS = 11;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;
    OrthographicCamera camera;
    Viewport viewport;

    public snake7(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/8but.44.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake8);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
