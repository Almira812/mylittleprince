...
public class in18 implements Screen {
    ...
    public in18(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        font = new BitmapFont();
        walkSheet = new Texture(Gdx.files.internal("day3/r.18.41.png")); // находит картинку с анимацией
