...
public class fx9 implements Screen {
    ...
    public fx9(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/10iopen.38.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx10);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
