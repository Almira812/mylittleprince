...
public class fox5 implements Screen {
    ...
    public fox5(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/before/6icannot.35.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fox6);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
