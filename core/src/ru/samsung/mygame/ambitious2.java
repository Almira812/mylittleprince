...
public class ambitious2 implements Screen {
    ...
    private static final int FRAME_COLS = 47, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public ambitious2(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/2.Ambitious/3.47nicehat.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.asteroud329);        //            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
