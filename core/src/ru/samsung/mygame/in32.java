...
public class in32 implements Screen {
    ...
    private static final int FRAME_COLS = 7, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    ...
    public void show() {
        ...
        font = new BitmapFont();
        walkSheet = new Texture(Gdx.files.internal("d.32.7.png")); // находит картинку с анимацией
