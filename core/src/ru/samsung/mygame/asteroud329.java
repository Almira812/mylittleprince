...
public class asteroud329 implements Screen {
    Camera camera;
    ...
    public asteroud329(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        mapBody = new Array<>();
        map = new TmxMapLoader().load("asteroud329.tmx");
    ...
    public void render(float delta) {
        ...
        if (sprince.getBody().getPosition().x > 550) { // если прошел
            myGdxGame.setScreen(myGdxGame.fonar);
        }
