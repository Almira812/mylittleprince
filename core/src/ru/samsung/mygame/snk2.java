...
public class snk2 implements Screen {
    ...
    private static final int FRAME_COLS = 5, FRAME_ROWS = 9;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;
    OrthographicCamera camera;
    Viewport viewport;

    public snk2(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/three/3iwanna.45.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snk3);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
