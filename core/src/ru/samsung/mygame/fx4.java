...
public class fx4 implements Screen {
    ...
    public fx4(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/5yes.14.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx5);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
