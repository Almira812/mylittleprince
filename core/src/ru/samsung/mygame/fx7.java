...
public class fx7 implements Screen {
    ...
    public fx7(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/8znachit.27.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx8);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
