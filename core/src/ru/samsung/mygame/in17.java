...
public class in17 implements Screen {
    ...
    private static final int FRAME_COLS = 5, FRAME_ROWS = 2;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public in17(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("day3/r.17.10.png")); // находит картинку с анимацией с солнцем
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.int18);
            }
        } else {
