...
public class snk3 implements Screen {
    ...
    public snk3(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/three/4myukus.49.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snk4);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
