...
public class snake9 implements Screen {
    ...
    private static final int FRAME_COLS = 31, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public snake9(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/10youcannot.31.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake10);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
