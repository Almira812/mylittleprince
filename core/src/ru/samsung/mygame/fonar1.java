...
public class fonar1 implements Screen {
    ...
    public fonar1(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/3.Fonar/2.26goodday.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fonar2);          //          !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
