...
public class fox2 implements Screen {
    ...
    public fox2(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/before/3whoareyou.9.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fox3);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
