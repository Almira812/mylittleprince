...
public class snake5 implements Screen {
    ...
    public snake5(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/6it'sadessert.36.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake6);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
