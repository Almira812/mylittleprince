...
public class in35 implements Screen {
    MyGdxGame myGdxGame;
    SpriteBatch batch;
    BitmapFont font;
    ...
    private static final int FRAME_COLS = 2, FRAME_ROWS = 6;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;
    OrthographicCamera camera;
    Viewport viewport;

    public in35(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        font = new BitmapFont();
        walkSheet = new Texture(Gdx.files.internal("day4/w.35.11.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.int36);
            }
        } else {
