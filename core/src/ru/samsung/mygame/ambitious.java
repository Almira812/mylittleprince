...
public class ambitious implements Screen {
    ...
    private static final int FRAME_COLS = 2, FRAME_ROWS = 13;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;
    OrthographicCamera camera;
    Viewport viewport;

    public ambitious(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/2.Ambitious/26goodday.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.ambitious1);               //     !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
