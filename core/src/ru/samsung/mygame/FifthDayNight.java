...
public class FifthDayNight implements Screen {
    MyGdxGame myGdxGame;
    SpriteBatch batch;
    BitmapFont font;
    Texture img;
    ...
    public FifthDayNight(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        textMapTexture = new Texture("dessert/dessert4.png");
        pos = new Vector2(0, 0);
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            ...
            if (pos.x > 1480 && pos.x < 1780  ///проверка колпака. Если колпак покрывает розу, то
                    && pos.y > 0 && pos.y < 550)
                myGdxGame.setScreen(myGdxGame.next5); // он переводит игрока на следующий экран (на игру вулканоооо)
