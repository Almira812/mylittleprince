...
public class fox6 implements Screen {
    ...
    public fox6(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/before/7sorry.13.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fox7);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
