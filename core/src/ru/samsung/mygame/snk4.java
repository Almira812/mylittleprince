...
public class snk4 implements Screen {
    ...
    public snk4(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/three/5areyouokey.12.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snk5);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
