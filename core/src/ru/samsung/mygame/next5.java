...
public class next5 implements Screen {
    ...
    private static final int FRAME_COLS = 6, FRAME_ROWS = 3;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public next5(MyGdxGame myGdxGame) {
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.SixthDaySun);
            }
        } else {
