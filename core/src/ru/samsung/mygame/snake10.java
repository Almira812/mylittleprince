...
public class snake10 implements Screen {
    ...
    public snake10(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/11ican.41.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake11);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
