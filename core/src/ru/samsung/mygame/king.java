...
public class king implements Screen {
    ...
    public king(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/1.King/19king.png")); // находит картинку с анимацией
