...
public class in9 implements Screen {
    ...
    private static final int FRAME_COLS = 6, FRAME_ROWS = 5;//сколько столбцов, сколько строк в анимации
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("day2/frost2.9.30.png")); // находит картинку с анимацией
