...
public class snake6 implements Screen {
    ...
    public snake6(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/7you'restrange.38.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake7);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
