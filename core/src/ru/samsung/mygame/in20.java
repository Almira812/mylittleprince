...
public class in20 implements Screen {
    ...
    private static final int FRAME_COLS = 22, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    ...
    public void show() {
        ...
        font = new BitmapFont();
        walkSheet = new Texture(Gdx.files.internal("r.20.22.png")); // находит картинку с анимацией
