...
public class snake implements Screen {
    ...
    public snake(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/1pgood.15.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake1);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
