...
public class in29 implements Screen {
    ...
    private static final int FRAME_COLS = 48, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    ...
    public void show() {
        ...
        font = new BitmapFont();
        walkSheet = new Texture(Gdx.files.internal("g.29.48.png")); // находит картинку с анимацией
