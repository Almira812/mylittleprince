...
public class geograf5 implements Screen {
    ...
    private static final int FRAME_COLS = 36, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public geograf5(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("SuperPrince-diolog/4.Geograf/6.36interesting.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.geograf6);             //       !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
