...
public class snake8 implements Screen {
    ...
    public snake8(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/9areyou.32.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake9);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
