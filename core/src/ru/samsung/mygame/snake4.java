...
public class snake4 implements Screen {
    ...
    private static final int FRAME_COLS = 32, FRAME_ROWS = 1;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public snake4(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/5that's how.32.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake5);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
