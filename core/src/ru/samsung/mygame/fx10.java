...
public class fx10 implements Screen {
    ...
    private static final int FRAME_COLS = 4, FRAME_ROWS = 6;//сколько столбцов, сколько строк в анимации
    boolean isWalking; // что-то с анимацией
    boolean isPressedOnStart;

    public fx10(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/11iopen.23.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx11);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
