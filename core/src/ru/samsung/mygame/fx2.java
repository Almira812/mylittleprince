...
public class fx2 implements Screen {
    ...
    public fx2(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/two/after/3you.36.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.fx3);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
