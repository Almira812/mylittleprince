...
public class snake2 implements Screen {
    ...
    public snake2(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        walkSheet = new Texture(Gdx.files.internal("level 3/one/3whataplanet.27.png")); // находит картинку с анимацией
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            if (!isPressedOnStart) {
                ...
                myGdxGame.setScreen(myGdxGame.snake3);                   // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            }
        } else {
